...
class SearchTest extends AbstractOnlineTestCase
{
    ...
    public function testResultIteration()
    {
        $items = $this->getLDAP()->search('(objectClass=organizationalUnit)',
            getenv('TESTS_LAMINAS_LDAP_WRITEABLE_SUBTREE'), Ldap\Ldap::SEARCH_SCOPE_SUB
        );
    ...
    {
        $items = $this->getLDAP()->search('(objectClass=account)', getenv('TESTS_LAMINAS_LDAP_WRITEABLE_SUBTREE'),
    ...
    {
        $entries = $this->getLDAP()->search('(objectClass=account)', getenv('TESTS_LAMINAS_LDAP_WRITEABLE_SUBTREE'),
            Ldap\Ldap::SEARCH_SCOPE_SUB
        );
    ...
    public function testSorting()
    {
        ...
        $items   = $this->getLDAP()->search('(l=*)', getenv('TESTS_LAMINAS_LDAP_WRITEABLE_SUBTREE'),
    ...
    public function testUnknownCollectionClassThrowsException()
    {
        try {
            $items = $this->getLDAP()->search('(objectClass=organizationalUnit)',
                getenv('TESTS_LAMINAS_LDAP_WRITEABLE_SUBTREE'), Ldap\Ldap::SEARCH_SCOPE_SUB, array(), null,
